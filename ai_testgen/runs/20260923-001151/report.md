# AI test generation run 20260923-001151
...
|---|--------|------------------|----------|---------|--------------|----------|------|
| 1 | `events/views_profile.py` | 32 | 1 | llm-error | 0 | 1.2 | HTTP 503 from https://generativelanguage.googleapis.com/v1beta/openai/chat/completions: [{
  "error": {
    "code": 503,
...
`python -m ai_testgen --provider replay --replay-dir ai_testgen/runs/20260923-001151/responses`
